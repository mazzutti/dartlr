...
class TokenRewriteStream extends CommonTokenStream {
  ...
  void insertAfter(Dynamic d, Object text, [String programName = DEFAULT_PROGRAM_NAME]) {
    int index = (d is Token) ? d.tokenIndex : d;
    insertBefore(index + 1, text, programName);
  }

  void insertBefore(Dynamic d , Object text, [String programName = DEFAULT_PROGRAM_NAME]) {
    int  index = (d is Token) ? d.tokenIndex : d;   
  ...
  void replace(Dynamic d1, Object text, [Dynamic d2 , String programName = DEFAULT_PROGRAM_NAME]) {
  ...
  void delete(Dynamic d1, [Dynamic d2, String programName = DEFAULT_PROGRAM_NAME]) {    
    int to, from = (d1 is Token) ? d1.tokenIndex : d1;
    if(d2 == null) to = from;

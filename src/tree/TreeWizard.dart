...
class TreeWizard {
  ...
  TreeWizard(this._adaptor, [Dynamic tokenNames]) {
  ...
  */
  ...
  Object findFirst(Object t, Dynamic type) => null;
...
class Visitor implements ContextVisitor {

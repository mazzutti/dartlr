...
class BaseTreeAdaptor implements TreeAdaptor {
  ...
  */
  ...
  Object create(int tokenType, Dynamic from, [String text]) {
    if(from is String){
   ...
   */
  abstract Token createTokenFromToken(Token fromToken);
   ...
   *  override this method and any other createToken variant.
   */
  abstract Token createToken(int tokenType, String text);

// $ANTLR 3.4 t057autoAST8Parser.g 2012-06-07 21:59:41
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t057autoAST8Parser extends Parser {
  ...
  t057autoAST8Parser(TokenStream input) 
  ...
  t057autoAST8Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t057autoAST8Parser._tokenNames;

  String get grammarFileName() => "t057autoAST8.g";

  String getRecognizerClassName() => "t057autoAST8Parser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t057autoAST8.g:
   3:1: a : v= 'void' ^ . ';' ;*/
  t057autoAST8Parser_a_return a() {
    t057autoAST8Parser_a_return retval = new t057autoAST8Parser_a_return();
    ...
    try {
       ...
       3:5: v= 'void' ^ . ';'*/
      {
      	...
      	this.matchAny(this.input); 
      	  ...
      	  this._adaptor.addChild(root_0, wildcard1_tree);
...
class t057autoAST8Parser_a_return extends ParserRuleReturnScope {
  Object _tree;

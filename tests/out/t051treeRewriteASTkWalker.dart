// $ANTLR 3.4 t051treeRewriteASTkWalker.g 2012-06-07 21:59:32
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTkWalker extends TreeParser {
  ...
  t051treeRewriteASTkWalker(TreeNodeStream input) 
  ...
  t051treeRewriteASTkWalker.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTkWalker._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTkWalker.g";

  String getRecognizerClassName() => "t051treeRewriteASTkWalker";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTkWalker.g:
   9:1: a : ^(x= ID y= INT ) ;*/
  t051treeRewriteASTkWalker_a_return a() {
    this.traceIn("a", 1);
    t051treeRewriteASTkWalker_a_return retval = new t051treeRewriteASTkWalker_a_return();
...
class t051treeRewriteASTkWalker_a_return extends TreeRuleReturnScope {
  CommonTree _tree;

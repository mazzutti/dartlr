// $ANTLR 3.4 t058rewriteAST82Parser.g 2012-06-07 21:59:37
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t058rewriteAST82Parser extends Parser {
  ...
  t058rewriteAST82Parser(TokenStream input) 
  ...
  t058rewriteAST82Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t058rewriteAST82Parser._tokenNames;

  String get grammarFileName() => "t058rewriteAST82.g";

  String getRecognizerClassName() => "t058rewriteAST82Parser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t058rewriteAST82.g:
   4:1: a : b c -> b c ;*/
  t058rewriteAST82Parser_a_return a() {
    t058rewriteAST82Parser_a_return retval = new t058rewriteAST82Parser_a_return();
    retval.start = this.input.LT(1);


    Object root_0 = null;

    t058rewriteAST82Parser_b_return b1 =null;

    t058rewriteAST82Parser_c_return c2 =null;
  ...
  /* ../runtime/dart/tests/grammars/t058rewriteAST82.g:
   5:1: b : ID -> ID ;*/
  t058rewriteAST82Parser_b_return b() {
    t058rewriteAST82Parser_b_return retval = new t058rewriteAST82Parser_b_return();
    retval.start = this.input.LT(1);
  ...
  /* ../runtime/dart/tests/grammars/t058rewriteAST82.g:
   6:1: c : INT -> INT ;*/
  t058rewriteAST82Parser_c_return c() {
    t058rewriteAST82Parser_c_return retval = new t058rewriteAST82Parser_c_return();
    retval.start = this.input.LT(1);
...
class t058rewriteAST82Parser_a_return extends ParserRuleReturnScope {
  Object _tree;
...
class t058rewriteAST82Parser_b_return extends ParserRuleReturnScope {
  Object _tree;
...
class t058rewriteAST82Parser_c_return extends ParserRuleReturnScope {
  Object _tree;

// $ANTLR 3.4 t051treeRewriteASTnParser.g 2012-06-07 21:59:45
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTnParser extends Parser {
  ...
  t051treeRewriteASTnParser(TokenStream input) 
  ...
  t051treeRewriteASTnParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTnParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTn.g";

  String getRecognizerClassName() => "t051treeRewriteASTnParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTn.g:
   6:1: a : ID INT -> ^( ID INT ) ;*/
  t051treeRewriteASTnParser_a_return a() {
    t051treeRewriteASTnParser_a_return retval = new t051treeRewriteASTnParser_a_return();
...
class t051treeRewriteASTnParser_a_return extends ParserRuleReturnScope {
  Object _tree;

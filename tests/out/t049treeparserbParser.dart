// $ANTLR 3.4 t049treeparserbParser.g 2012-06-07 21:59:44
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t049treeparserbParser extends Parser {
  ...
  t049treeparserbParser(TokenStream input) 
  ...
  t049treeparserbParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t049treeparserbParser._tokenNames;

  String get grammarFileName() => "t049treeparserb.g";

  String getRecognizerClassName() => "t049treeparserbParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t049treeparserb.g:
   6:1: a : ID INT -> ^( ID INT ) ;*/
  t049treeparserbParser_a_return a() {
    t049treeparserbParser_a_return retval = new t049treeparserbParser_a_return();
...
class t049treeparserbParser_a_return extends ParserRuleReturnScope {
  Object _tree;

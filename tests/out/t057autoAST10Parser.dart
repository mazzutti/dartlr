// $ANTLR 3.4 t057autoAST10Parser.g 2012-06-07 21:59:48
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t057autoAST10Parser extends Parser {
  ...
  t057autoAST10Parser(TokenStream input) 
  ...
  t057autoAST10Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t057autoAST10Parser._tokenNames;

  String get grammarFileName() => "t057autoAST10.g";

  String getRecognizerClassName() => "t057autoAST10Parser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t057autoAST10.g:
   3:1: a : v= 'void' x= . ^ ';' ;*/
  t057autoAST10Parser_a_return a() {
    t057autoAST10Parser_a_return retval = new t057autoAST10Parser_a_return();
...
class t057autoAST10Parser_a_return extends ParserRuleReturnScope {
  Object _tree;

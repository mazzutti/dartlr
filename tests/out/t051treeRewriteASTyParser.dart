// $ANTLR 3.4 t051treeRewriteASTyParser.g 2012-06-07 21:59:46
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTyParser extends Parser {
  ...
  t051treeRewriteASTyParser(TokenStream input) 
  ...
  t051treeRewriteASTyParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTyParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTy.g";

  String getRecognizerClassName() => "t051treeRewriteASTyParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTy.g:
   6:1: a : 'boo' ID INT -> 'boo' ^( ID INT ) ;*/
  t051treeRewriteASTyParser_a_return a() {
    t051treeRewriteASTyParser_a_return retval = new t051treeRewriteASTyParser_a_return();
...
class t051treeRewriteASTyParser_a_return extends ParserRuleReturnScope {
  Object _tree;

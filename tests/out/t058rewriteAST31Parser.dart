// $ANTLR 3.4 t058rewriteAST31Parser.g 2012-06-07 21:59:48
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t058rewriteAST31Parser extends Parser {
  ...
  t058rewriteAST31Parser(TokenStream input) 
  ...
  t058rewriteAST31Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t058rewriteAST31Parser._tokenNames;

  String get grammarFileName() => "t058rewriteAST31.g";

  String getRecognizerClassName() => "t058rewriteAST31Parser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t058rewriteAST31.g:
   5:1: a : ID ( ',' ID )* -> ( ^( VAR[\"var\"] ID ) )+ ;*/
  t058rewriteAST31Parser_a_return a() {
    t058rewriteAST31Parser_a_return retval = new t058rewriteAST31Parser_a_return();
  ...
  /* ../runtime/dart/tests/grammars/t058rewriteAST31.g:
   6:1: type : ( 'int' | 'float' );*/
  t058rewriteAST31Parser_type_return type() {
    t058rewriteAST31Parser_type_return retval = new t058rewriteAST31Parser_type_return();
    retval.start = this.input.LT(1);
...
class t058rewriteAST31Parser_a_return extends ParserRuleReturnScope {
  Object _tree;
...
class t058rewriteAST31Parser_type_return extends ParserRuleReturnScope {
  Object _tree;

// $ANTLR 3.4 t056lexer7Parser.g 2012-06-07 21:59:36
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t056lexer7Parser extends Parser {
  ...
  t056lexer7Parser(TokenStream input) 
    : super.fromRecognizerSharedState(input, new RecognizerSharedState()) {
  }



  t056lexer7Parser.fromRecognizerSharedState
    (TokenStream input, RecognizerSharedState state) 
      : super.fromRecognizerSharedState(input, state) {
    
  }    

  List<String> get tokenNames() => t056lexer7Parser._tokenNames;

  String get grammarFileName() => "t056lexer7.g";

  String getRecognizerClassName() => "t056lexer7Parser";

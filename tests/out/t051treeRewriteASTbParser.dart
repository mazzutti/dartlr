// $ANTLR 3.4 t051treeRewriteASTbParser.g 2012-06-07 21:59:45
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTbParser extends Parser {
  ...
  t051treeRewriteASTbParser(TokenStream input) 
  ...
  t051treeRewriteASTbParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTbParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTb.g";

  String getRecognizerClassName() => "t051treeRewriteASTbParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTb.g:
   6:1: a : ID INT -> ^( ID INT ) ;*/
  t051treeRewriteASTbParser_a_return a() {
    t051treeRewriteASTbParser_a_return retval = new t051treeRewriteASTbParser_a_return();
...
class t051treeRewriteASTbParser_a_return extends ParserRuleReturnScope {
  Object _tree;

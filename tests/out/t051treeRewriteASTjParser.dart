// $ANTLR 3.4 t051treeRewriteASTjParser.g 2012-06-07 21:59:49
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTjParser extends Parser {
  ...
  t051treeRewriteASTjParser(TokenStream input) 
  ...
  t051treeRewriteASTjParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTjParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTj.g";

  String getRecognizerClassName() => "t051treeRewriteASTjParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTj.g:
   6:1: a : ID INT -> ^( ID INT ) ;*/
  t051treeRewriteASTjParser_a_return a() {
    t051treeRewriteASTjParser_a_return retval = new t051treeRewriteASTjParser_a_return();
...
class t051treeRewriteASTjParser_a_return extends ParserRuleReturnScope {
  Object _tree;

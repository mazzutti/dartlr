// $ANTLR 3.4 t057autoAST47Parser.g 2012-06-07 21:59:48
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t057autoAST47Parser extends Parser {
  ...
  t057autoAST47Parser(TokenStream input) 
  ...
  t057autoAST47Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t057autoAST47Parser._tokenNames;

  String get grammarFileName() => "t057autoAST47.g";

  String getRecognizerClassName() => "t057autoAST47Parser";


  // $ANTLR start "decl"
  /* ../runtime/dart/tests/grammars/t057autoAST47.g:
   4:1: decl : type ^ ID '=' ! INT ';' !;*/
  t057autoAST47Parser_decl_return decl() {
    t057autoAST47Parser_decl_return retval = new t057autoAST47Parser_decl_return();
    ...
    t057autoAST47Parser_type_return type1 =null;
  ...
  /* ../runtime/dart/tests/grammars/t057autoAST47.g:
   5:1: type : ( 'int' | 'float' );*/
  t057autoAST47Parser_type_return type() {
    t057autoAST47Parser_type_return retval = new t057autoAST47Parser_type_return();
    retval.start = this.input.LT(1);
...
class t057autoAST47Parser_decl_return extends ParserRuleReturnScope {
  Object _tree;
...
class t057autoAST47Parser_type_return extends ParserRuleReturnScope {
  Object _tree;

// $ANTLR 3.4 t051treeRewriteASTaaParser.g 2012-06-07 21:59:43
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTaaParser extends Parser {
  ...
  t051treeRewriteASTaaParser(TokenStream input) 
  ...
  t051treeRewriteASTaaParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTaaParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTaa.g";

  String getRecognizerClassName() => "t051treeRewriteASTaaParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTaa.g:
   6:1: a : 'boo' ID INT -> ^( 'boo' ^( ID INT ) ) ;*/
  t051treeRewriteASTaaParser_a_return a() {
    t051treeRewriteASTaaParser_a_return retval = new t051treeRewriteASTaaParser_a_return();
...
class t051treeRewriteASTaaParser_a_return extends ParserRuleReturnScope {
  Object _tree;

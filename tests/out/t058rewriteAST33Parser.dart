// $ANTLR 3.4 t058rewriteAST33Parser.g 2012-06-07 21:59:42
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t058rewriteAST33Parser extends Parser {
  ...
  t058rewriteAST33Parser(TokenStream input) 
  ...
  t058rewriteAST33Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t058rewriteAST33Parser._tokenNames;

  String get grammarFileName() => "t058rewriteAST33.g";

  String getRecognizerClassName() => "t058rewriteAST33Parser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t058rewriteAST33.g:
   5:1: a : lc= '{' ( ID )+ '}' -> ^( BLOCK[$lc,\"block\"] ( ID )+ ) ;*/
  t058rewriteAST33Parser_a_return a() {
    t058rewriteAST33Parser_a_return retval = new t058rewriteAST33Parser_a_return();
  ...
  /* ../runtime/dart/tests/grammars/t058rewriteAST33.g:
   6:1: type : ( 'int' | 'float' );*/
  t058rewriteAST33Parser_type_return type() {
    t058rewriteAST33Parser_type_return retval = new t058rewriteAST33Parser_type_return();
    retval.start = this.input.LT(1);
...
class t058rewriteAST33Parser_a_return extends ParserRuleReturnScope {
  Object _tree;
...
class t058rewriteAST33Parser_type_return extends ParserRuleReturnScope {
  Object _tree;

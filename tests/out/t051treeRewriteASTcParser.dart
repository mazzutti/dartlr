// $ANTLR 3.4 t051treeRewriteASTcParser.g 2012-06-07 21:59:43
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTcParser extends Parser {
  ...
  t051treeRewriteASTcParser(TokenStream input) 
  ...
  t051treeRewriteASTcParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTcParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTc.g";

  String getRecognizerClassName() => "t051treeRewriteASTcParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTc.g:
   6:1: a : ( ID INT -> ^( ID INT ) | INT );*/
  t051treeRewriteASTcParser_a_return a() {
    t051treeRewriteASTcParser_a_return retval = new t051treeRewriteASTcParser_a_return();
...
class t051treeRewriteASTcParser_a_return extends ParserRuleReturnScope {
  Object _tree;

// $ANTLR 3.4 t057autoAST26Parser.g 2012-06-07 21:59:37
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t057autoAST26Parser extends Parser {
  ...
  t057autoAST26Parser(TokenStream input) 
  ...
  t057autoAST26Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t057autoAST26Parser._tokenNames;

  String get grammarFileName() => "t057autoAST26.g";

  String getRecognizerClassName() => "t057autoAST26Parser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t057autoAST26.g:
   3:1: a : ID ( ( '+' | '-' ) ^ ID )* ;*/
  t057autoAST26Parser_a_return a() {
    t057autoAST26Parser_a_return retval = new t057autoAST26Parser_a_return();
...
class t057autoAST26Parser_a_return extends ParserRuleReturnScope {
  Object _tree;

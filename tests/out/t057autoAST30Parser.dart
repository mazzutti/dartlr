// $ANTLR 3.4 t057autoAST30Parser.g 2012-06-07 21:59:41
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t057autoAST30Parser extends Parser {
  ...
  t057autoAST30Parser(TokenStream input) 
  ...
  t057autoAST30Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t057autoAST30Parser._tokenNames;

  String get grammarFileName() => "t057autoAST30.g";

  String getRecognizerClassName() => "t057autoAST30Parser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t057autoAST30.g:
   3:1: a :~ '+' ^ INT ;*/
  t057autoAST30Parser_a_return a() {
    t057autoAST30Parser_a_return retval = new t057autoAST30Parser_a_return();
...
class t057autoAST30Parser_a_return extends ParserRuleReturnScope {
  Object _tree;

// $ANTLR 3.4 t018llstarLexer.g 2012-06-07 21:59:49
#library('dart:dartlr');
...
class t018llstarLexer extends Lexer {
  ...
  t018llstarLexer([CharStream input]) 
    : super.fromRecognizerSharedState
      (input, new RecognizerSharedState()) {
  }

  t018llstarLexer.fromRecognizerSharedState(
  ...
  String getRecognizerClassName() => "t018llstarLexer";
  ...
  void mID() {
    try {
  	  ...
  	  int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
  	  /* ../runtime/dart/tests/grammars/t018llstar.g:
  	   103:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | 
  	   '0' .. '9' | '_' )* )*/
  	  /* ../runtime/dart/tests/grammars/t018llstar.g:
  	   103:9: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | 
  	   '0' .. '9' | '_' )**/
  	  {
  ...
  void mTokens() {
    /* ../runtime/dart/tests/grammars/t018llstar.g: 
     ...
     T__15 | T__16 | T__17 | T__18 | T__19 | T__20 | ID | INT | WS ) */
    int alt4 = 17;
    ...
    case 99 /*'c'*/:
      ...
      if((LA4_8 == 104/*104 /*'h'*/*/)) {
        ...
        if((LA4_19 == 97/*97 /*'a'*/*/)) {
          ...
          if((LA4_23 == 114/*114 /*'r'*/*/)) {
            int LA4_27 = this.input.LA(5);

            if(((LA4_27 >= 48 /*'0'*/ && LA4_27 <= 57 /*'9'*/)
              || (LA4_27 >= 65 /*'A'*/ && LA4_27 <= 90 /*'Z'*/)
              || LA4_27 == 95/*95 /*'_'*/*/
              || (LA4_27 >= 97 /*'a'*/ && LA4_27 <= 122 /*'z'*/))) {
              alt4 = 15;
            }
            else {
              alt4 = 9;
    ...
    case 105 /*'i'*/:
      ...
      if((LA4_10 == 110/*110 /*'n'*/*/)) {
        int LA4_21 = this.input.LA(3);

        if((LA4_21 == 116/*116 /*'t'*/*/)) {
          int LA4_25 = this.input.LA(4);

          if(((LA4_25 >= 48 /*'0'*/ && LA4_25 <= 57 /*'9'*/)
            || (LA4_25 >= 65 /*'A'*/ && LA4_25 <= 90 /*'Z'*/)
            || LA4_25 == 95/*95 /*'_'*/*/
            || (LA4_25 >= 97 /*'a'*/ && LA4_25 <= 122 /*'z'*/))) {
            alt4 = 15;
          }
          else {
            alt4 = 11;
    ...
    case 118 /*'v'*/:
      {
      int LA4_11 = this.input.LA(2);

      if((LA4_11 == 111/*111 /*'o'*/*/)) {
        int LA4_22 = this.input.LA(3);

// $ANTLR 3.4 t056lexer8Parser.g 2012-06-07 21:59:46
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t056lexer8Parser extends Parser {
  ...
  t056lexer8Parser(TokenStream input) 
    : super.fromRecognizerSharedState(input, new RecognizerSharedState()) {
  }



  t056lexer8Parser.fromRecognizerSharedState
    (TokenStream input, RecognizerSharedState state) 
      : super.fromRecognizerSharedState(input, state) {
    
  }    

  List<String> get tokenNames() => t056lexer8Parser._tokenNames;

  String get grammarFileName() => "t056lexer8.g";

  String getRecognizerClassName() => "t056lexer8Parser";

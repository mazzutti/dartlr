// $ANTLR 3.4 t058rewriteAST51Parser.g 2012-06-07 21:59:42
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t058rewriteAST51Parser extends Parser {
  ...
  t058rewriteAST51Parser(TokenStream input) 
  ...
  t058rewriteAST51Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t058rewriteAST51Parser._tokenNames;

  String get grammarFileName() => "t058rewriteAST51.g";

  String getRecognizerClassName() => "t058rewriteAST51Parser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t058rewriteAST51.g:
   4:1: a : 'int' ID ( ',' ID )* ';' -> ( ^( 'int' ID ) )+ ;*/
  t058rewriteAST51Parser_a_return a() {
    t058rewriteAST51Parser_a_return retval = new t058rewriteAST51Parser_a_return();
  ...
  /* ../runtime/dart/tests/grammars/t058rewriteAST51.g:
   5:1: op : ( '+' | '-' );*/
  t058rewriteAST51Parser_op_return op() {
    t058rewriteAST51Parser_op_return retval = new t058rewriteAST51Parser_op_return();
    retval.start = this.input.LT(1);
...
class t058rewriteAST51Parser_a_return extends ParserRuleReturnScope {
  Object _tree;
...
class t058rewriteAST51Parser_op_return extends ParserRuleReturnScope {
  Object _tree;

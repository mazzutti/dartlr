// $ANTLR 3.4 t051treeRewriteASTbWalker.g 2012-06-07 21:59:36
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTbWalker extends TreeParser {
  ...
  t051treeRewriteASTbWalker(TreeNodeStream input) 
  ...
  t051treeRewriteASTbWalker.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTbWalker._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTbWalker.g";

  String getRecognizerClassName() => "t051treeRewriteASTbWalker";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTbWalker.g:
   9:1: a : ^( ID INT ) -> ^( INT ID ) ;*/
  t051treeRewriteASTbWalker_a_return a() {
    this.traceIn("a", 1);
    t051treeRewriteASTbWalker_a_return retval = new t051treeRewriteASTbWalker_a_return();
...
class t051treeRewriteASTbWalker_a_return extends TreeRuleReturnScope {
  CommonTree _tree;

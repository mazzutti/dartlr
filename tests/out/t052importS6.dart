// $ANTLR 3.4 t052importS6.g 2012-06-07 21:59:38
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t052importS6 extends Parser {
  ...
  t052importS6(TokenStream input) 
    : super.fromRecognizerSharedState(input, new RecognizerSharedState()) {
  }



  t052importS6.fromRecognizerSharedState
    (TokenStream input, RecognizerSharedState state) 
      : super.fromRecognizerSharedState(input, state) {
    
  }    

  List<String> get tokenNames() => t052importS6._tokenNames;

  String get grammarFileName() => "t052importS6.g";

  String getRecognizerClassName() => "t052importS6";
  ...
  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t052importS6.g:
   10:1: a : b ;*/
  void a() {
    try {
      /* ../runtime/dart/tests/grammars/t052importS6.g:

// $ANTLR 3.4 t051treeRewriteASTrParser.g 2012-06-07 21:59:37
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTrParser extends Parser {
  ...
  t051treeRewriteASTrParser(TokenStream input) 
  ...
  t051treeRewriteASTrParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTrParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTr.g";

  String getRecognizerClassName() => "t051treeRewriteASTrParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTr.g:
   6:1: a : x= ID INT -> ^( $x INT ) ;*/
  t051treeRewriteASTrParser_a_return a() {
    t051treeRewriteASTrParser_a_return retval = new t051treeRewriteASTrParser_a_return();
...
class t051treeRewriteASTrParser_a_return extends ParserRuleReturnScope {
  Object _tree;

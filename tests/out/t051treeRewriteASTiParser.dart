// $ANTLR 3.4 t051treeRewriteASTiParser.g 2012-06-07 21:59:46
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTiParser extends Parser {
  ...
  t051treeRewriteASTiParser(TokenStream input) 
  ...
  t051treeRewriteASTiParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTiParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTi.g";

  String getRecognizerClassName() => "t051treeRewriteASTiParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTi.g:
   6:1: a : ID INT -> ^( ID INT ) ;*/
  t051treeRewriteASTiParser_a_return a() {
    t051treeRewriteASTiParser_a_return retval = new t051treeRewriteASTiParser_a_return();
...
class t051treeRewriteASTiParser_a_return extends ParserRuleReturnScope {
  Object _tree;

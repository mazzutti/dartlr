// $ANTLR 3.4 t051treeRewriteASTmParser.g 2012-06-07 21:59:48
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTmParser extends Parser {
  ...
  t051treeRewriteASTmParser(TokenStream input) 
  ...
  t051treeRewriteASTmParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTmParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTm.g";

  String getRecognizerClassName() => "t051treeRewriteASTmParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTm.g:
   6:1: a : ID INT -> ^( ID INT ) ;*/
  t051treeRewriteASTmParser_a_return a() {
    t051treeRewriteASTmParser_a_return retval = new t051treeRewriteASTmParser_a_return();
...
class t051treeRewriteASTmParser_a_return extends ParserRuleReturnScope {
  Object _tree;

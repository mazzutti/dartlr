// $ANTLR 3.4 t051treeRewriteASTwParser.g 2012-06-07 21:59:45
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTwParser extends Parser {
  ...
  t051treeRewriteASTwParser(TokenStream input) 
  ...
  t051treeRewriteASTwParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTwParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTw.g";

  String getRecognizerClassName() => "t051treeRewriteASTwParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTw.g:
   6:1: a : ID INT -> ^( ID INT ) ;*/
  t051treeRewriteASTwParser_a_return a() {
    t051treeRewriteASTwParser_a_return retval = new t051treeRewriteASTwParser_a_return();
...
class t051treeRewriteASTwParser_a_return extends ParserRuleReturnScope {
  Object _tree;

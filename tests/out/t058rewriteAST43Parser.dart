// $ANTLR 3.4 t058rewriteAST43Parser.g 2012-06-07 21:59:31
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t058rewriteAST43Parser extends Parser {
  ...
  t058rewriteAST43Parser(TokenStream input) 
  ...
  t058rewriteAST43Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t058rewriteAST43Parser._tokenNames;

  String get grammarFileName() => "t058rewriteAST43.g";

  String getRecognizerClassName() => "t058rewriteAST43Parser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t058rewriteAST43.g:
   4:1: a : ( modifier )? type ID ( ',' ID )* ';' -> ( ^( type ( modifier )? ID ) )+ ;*/
  t058rewriteAST43Parser_a_return a() {
    t058rewriteAST43Parser_a_return retval = new t058rewriteAST43Parser_a_return();
    ...
    t058rewriteAST43Parser_modifier_return modifier1 =null;

    t058rewriteAST43Parser_type_return type2 =null;
    ...
    try {
      /* ../runtime/dart/tests/grammars/t058rewriteAST43.g:
       4:3: ( ( modifier )? type ID ( ',' ID )* ';' -> ( ^( type ( modifier )? ID ) )+ )*/
      /* ../runtime/dart/tests/grammars/t058rewriteAST43.g:
  ...
  /* ../runtime/dart/tests/grammars/t058rewriteAST43.g:
   5:1: type : 'int' ;*/
  t058rewriteAST43Parser_type_return type() {
    t058rewriteAST43Parser_type_return retval = new t058rewriteAST43Parser_type_return();
    retval.start = this.input.LT(1);
  ...
  /* ../runtime/dart/tests/grammars/t058rewriteAST43.g:
   6:1: modifier : 'public' ;*/
  t058rewriteAST43Parser_modifier_return modifier() {
    t058rewriteAST43Parser_modifier_return retval = new t058rewriteAST43Parser_modifier_return();
    retval.start = this.input.LT(1);
  ...
  static BitSet _FOLLOW_8_in_type55 = null;
  static BitSet get FOLLOW_8_in_type55() {
    if(_FOLLOW_8_in_type55 == null) 
      _FOLLOW_8_in_type55 = 
        new BitSet.fromList([0x0000000000000002]);
    return _FOLLOW_8_in_type55;
  }

  static BitSet _FOLLOW_9_in_modifier63 = null;
  static BitSet get FOLLOW_9_in_modifier63() {
    if(_FOLLOW_9_in_modifier63 == null) 
      _FOLLOW_9_in_modifier63 = 
        new BitSet.fromList([0x0000000000000002]);
    return _FOLLOW_9_in_modifier63;
  }
...
class t058rewriteAST43Parser_a_return extends ParserRuleReturnScope {
  Object _tree;
...
class t058rewriteAST43Parser_type_return extends ParserRuleReturnScope {
  Object _tree;
...
class t058rewriteAST43Parser_modifier_return extends ParserRuleReturnScope {
  Object _tree;

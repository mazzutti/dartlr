// $ANTLR 3.4 t051treeRewriteASTxParser.g 2012-06-07 21:59:47
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTxParser extends Parser {
  ...
  t051treeRewriteASTxParser(TokenStream input) 
  ...
  t051treeRewriteASTxParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTxParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTx.g";

  String getRecognizerClassName() => "t051treeRewriteASTxParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTx.g:
   6:1: a : ID INT -> ^( ID INT ) ;*/
  t051treeRewriteASTxParser_a_return a() {
    t051treeRewriteASTxParser_a_return retval = new t051treeRewriteASTxParser_a_return();
...
class t051treeRewriteASTxParser_a_return extends ParserRuleReturnScope {
  Object _tree;

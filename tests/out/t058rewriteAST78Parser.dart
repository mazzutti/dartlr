// $ANTLR 3.4 t058rewriteAST78Parser.g 2012-06-07 21:59:48
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t058rewriteAST78Parser extends Parser {
  ...
  t058rewriteAST78Parser(TokenStream input) 
  ...
  t058rewriteAST78Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t058rewriteAST78Parser._tokenNames;

  String get grammarFileName() => "t058rewriteAST78.g";

  String getRecognizerClassName() => "t058rewriteAST78Parser";


  // $ANTLR start "decl"
  /* ../runtime/dart/tests/grammars/t058rewriteAST78.g:
   5:1: decl : type ID '=' INT ';' -> ^( EXPR type ID INT ) ;*/
  t058rewriteAST78Parser_decl_return decl() {
    t058rewriteAST78Parser_decl_return retval = new t058rewriteAST78Parser_decl_return();
    ...
    t058rewriteAST78Parser_type_return type1 =null;
  ...
  /* ../runtime/dart/tests/grammars/t058rewriteAST78.g:
   6:1: type : ( 'int' | 'float' );*/
  t058rewriteAST78Parser_type_return type() {
    t058rewriteAST78Parser_type_return retval = new t058rewriteAST78Parser_type_return();
    retval.start = this.input.LT(1);
...
class t058rewriteAST78Parser_decl_return extends ParserRuleReturnScope {
  Object _tree;
...
class t058rewriteAST78Parser_type_return extends ParserRuleReturnScope {
  Object _tree;

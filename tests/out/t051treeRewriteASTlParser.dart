// $ANTLR 3.4 t051treeRewriteASTlParser.g 2012-06-07 21:59:47
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTlParser extends Parser {
  ...
  t051treeRewriteASTlParser(TokenStream input) 
  ...
  t051treeRewriteASTlParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTlParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTl.g";

  String getRecognizerClassName() => "t051treeRewriteASTlParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTl.g:
   6:1: a : ID INT -> ^( ID INT ) ;*/
  t051treeRewriteASTlParser_a_return a() {
    t051treeRewriteASTlParser_a_return retval = new t051treeRewriteASTlParser_a_return();
...
class t051treeRewriteASTlParser_a_return extends ParserRuleReturnScope {
  Object _tree;

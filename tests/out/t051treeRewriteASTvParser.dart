// $ANTLR 3.4 t051treeRewriteASTvParser.g 2012-06-07 21:59:46
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t051treeRewriteASTvParser extends Parser {
  ...
  t051treeRewriteASTvParser(TokenStream input) 
  ...
  t051treeRewriteASTvParser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t051treeRewriteASTvParser._tokenNames;

  String get grammarFileName() => "t051treeRewriteASTv.g";

  String getRecognizerClassName() => "t051treeRewriteASTvParser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t051treeRewriteASTv.g:
   6:1: a : ( ID INT -> ID INT | INT );*/
  t051treeRewriteASTvParser_a_return a() {
    t051treeRewriteASTvParser_a_return retval = new t051treeRewriteASTvParser_a_return();
...
class t051treeRewriteASTvParser_a_return extends ParserRuleReturnScope {
  Object _tree;

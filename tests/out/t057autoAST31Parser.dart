// $ANTLR 3.4 t057autoAST31Parser.g 2012-06-07 21:59:45
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t057autoAST31Parser extends Parser {
  ...
  t057autoAST31Parser(TokenStream input) 
  ...
  t057autoAST31Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t057autoAST31Parser._tokenNames;

  String get grammarFileName() => "t057autoAST31.g";

  String getRecognizerClassName() => "t057autoAST31Parser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t057autoAST31.g:
   3:1: a :~ '+' ^ INT ;*/
  t057autoAST31Parser_a_return a() {
    t057autoAST31Parser_a_return retval = new t057autoAST31Parser_a_return();
...
class t057autoAST31Parser_a_return extends ParserRuleReturnScope {
  Object _tree;

// $ANTLR 3.4 t058rewriteAST62Parser.g 2012-06-07 21:59:46
#library('dart:dartlr');

#import('dart:io');
#import('../../src/DartLRLib.dart');

class t058rewriteAST62Parser extends Parser {
  ...
  t058rewriteAST62Parser(TokenStream input) 
  ...
  t058rewriteAST62Parser.fromRecognizerSharedState
  ...
  List<String> get tokenNames() => t058rewriteAST62Parser._tokenNames;

  String get grammarFileName() => "t058rewriteAST62.g";

  String getRecognizerClassName() => "t058rewriteAST62Parser";


  // $ANTLR start "a"
  /* ../runtime/dart/tests/grammars/t058rewriteAST62.g:
   5:1: a : x= ID (y= b )? -> ( $x $y)? ;*/
  t058rewriteAST62Parser_a_return a() {
    t058rewriteAST62Parser_a_return retval = new t058rewriteAST62Parser_a_return();
    ...
    Token x = null;
    t058rewriteAST62Parser_b_return y =null;
  ...
  /* ../runtime/dart/tests/grammars/t058rewriteAST62.g:
   6:1: b : ID ;*/
  t058rewriteAST62Parser_b_return b() {
    t058rewriteAST62Parser_b_return retval = new t058rewriteAST62Parser_b_return();
    retval.start = this.input.LT(1);
...
class t058rewriteAST62Parser_a_return extends ParserRuleReturnScope {
  Object _tree;
...
class t058rewriteAST62Parser_b_return extends ParserRuleReturnScope {
  Object _tree;

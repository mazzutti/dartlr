...
part "../out/t042astLexer.dart";
part "../out/t042astParser.dart";
...
main() {
  test('testR2a_t042ast', () {
    ...
    var ret = parser.r2();
    expect((ret.tree as Tree).toStringTree(), equals("(assert (+ 2 3))"));
  });
  ...
  test('testR2b_t042ast', () {
    ...
    var ret = parser.r2();
    expect((ret.tree as Tree).toStringTree(), equals("(assert (+ 2 3) 5)"));
  });
  ...
  test('testR3a_t042ast', () {
    ...
    var ret = parser.r3();
    expect((ret.tree as Tree).toStringTree(),equals("(if 1 fooze)"));
  });
  ...
  test('testR3b_t042ast', () {
    ...
    var ret = parser.r3();
    expect((ret.tree as Tree).toStringTree(), equals("(if 1 fooze fooze)"));
  });
  ...
  test('testR4a_t042ast', () {
    ...
    var ret = parser.r4();
    expect((ret.tree as Tree).toStringTree(), equals("(while 2 fooze)"));
  });
  ...
  test('testR5a_t042ast', () {
    ...
    var ret = parser.r5();
    expect((ret.tree as Tree).toStringTree(), equals("return"));
  });
  ...
  test('testR5b_t042ast', () {
    ...
    var ret = parser.r5();
    expect((ret.tree as Tree).toStringTree(), equals("(return (+ 2 3))"));
  });
  ...
  test('testR6a_t042ast', () {
    ...
    var ret = parser.r6();
    expect((ret.tree as Tree).toStringTree(), equals("3"));
  });
  ...
  test('testR6b_t042ast', () {
    ...
    var ret = parser.r6();
    expect((ret.tree as Tree).toStringTree(), equals("3 a"));
  });
  ...
  test('testR8_t042ast', () {
    ...
    var ret = parser.r8();
    expect((ret.tree as Tree).toStringTree(), equals("(var bool foo)"));
  });
  ...
  test('testR9_t042ast', () {
    ...
    var ret = parser.r9();
    expect((ret.tree as Tree).toStringTree(), equals("(VARDEF int foo)"));
  });
  ...
  test('testR10_t042ast', () {
    ...
    var ret = parser.r10();
    expect((ret.tree as Tree).toStringTree(), equals("10.0"));
  });
  ...
  test('testR11a_t042ast', () {
    ...
    var ret = parser.r11();
    expect((ret.tree as Tree).toStringTree(), equals("(EXPR (+ 1 2))"));
  });
  ...
  test('testR11b_t042ast', () {
    ...
    var ret = parser.r11();
    expect((ret.tree as Tree).toStringTree(), equals("EXPR"));
  });
  ...
  test('testR12a_t042ast', () {
    ...
    var ret = parser.r12();
    expect((ret.tree as Tree).toStringTree(), equals("foo"));
  });
  ...
  test('testR12b_t042ast', () {
    ...
    var ret = parser.r12();
    expect((ret.tree as Tree).toStringTree(), equals("foo bar gnurz"));
  });
  ...
  test('testR13a_t042ast', () {
    ...
    var ret = parser.r13();
    expect((ret.tree as Tree).toStringTree(), equals("(int foo)"));
  });
  ...
  test('testR13b_t042ast', () {
    ...
    var ret = parser.r13();
    expect((ret.tree as Tree).toStringTree(), equals("(bool foo bar gnurz)"));
  });
  ...
  test('testR14a_t042ast', () {
    ...
    var ret = parser.r14();
    expect((ret.tree as Tree).toStringTree(), equals("(EXPR (+ 1 2) int)"));
  });
  ...
  test('testR14b_t042ast', () {
    ...
    var ret = parser.r14();
    expect((ret.tree as Tree).toStringTree(), equals("(EXPR (+ 1 2) int bool)"));
  });
  ...
  test('testR14c_t042ast', () {
    ...
    var ret = parser.r14();
    expect((ret.tree as Tree).toStringTree(), equals("(EXPR int bool)"));
  });
  ...
  test('testR14d_t042ast', () {
    ...
    var ret = parser.r14();
    expect((ret.tree as Tree).toStringTree(), equals("(EXPR fooze fooze int bool)"));
  });
  ...
  test('testR14e_t042ast', () {
    ...
    var ret = parser.r14();
    expect((ret.tree as Tree).toStringTree()
  ...
  test('testR15_t042ast', () {
    ...
    var ret = parser.r15();
    expect((ret.tree as Tree).toStringTree(), equals("7 7"));
  });
  ...
  test('testR16b_t042ast', () {
    ...
    var ret = parser.r16();
    expect((ret.tree as Tree).toStringTree(), equals("(int foo) (int bar) (int gnurz)"));
  });
  ...
  test('testR17_t042ast', () {
    ...
    var ret = parser.r17();
    expect((ret.tree as Tree).toStringTree(), equals("(for fooze (+ 1 2) fooze fooze)"));
  });
  ...
  test('testR18_t042ast', () {
    ...
    var ret = parser.r18();
    expect((ret.tree as Tree).toStringTree(), equals("BLOCK"));
  });
  ...
  test('testR19_t042ast', () {
    ...
    var ret = parser.r19();
    expect((ret.tree as Tree).toStringTree(), equals("for"));
  });
  ...
  test('testR24_t042ast', () {
    ...
    var ret = parser.r24();
    expect((ret.tree as Tree).toStringTree(), equals("(fooze (+ 1 2))"));
  });
  ...
  test('testR26_t042ast', () {
    ...
    var ret = parser.r26();
    expect((ret.tree as Tree).toStringTree(), equals("(BLOCK fooze fooze2)"));
  });
  ...
  test('testR27_t042ast', () {
    ...
    var ret = parser.r27();
    expect((ret.tree as Tree).toStringTree(), equals("(fooze (fooze (+ 1 2)))"));
  });
  ...
  test('testR29_t042ast', () {
    ...
    CommonTokenStream tstream = new CommonTokenStream(lexer);
    t042astParser parser = new t042astParser(tstream);
    expect(() => parser.r29(), throwsA(new isInstanceOf<Exception>()));
  });
  ...
  test('test32a_t042ast', () {
    ...
    expect((ret.tree as Tree).toStringTree(), equals("gnurz"));
  });
  ...
  test('test32b_t042ast', () {
    ...
    expect((ret.tree as Tree).toStringTree(), equals("32"));
  });
  ...
  test('test33_t042ast', () {
    ...
    parser.flag = 2;
    var ret = parser.r33();
    expect((ret.tree as Tree).toStringTree(), equals("fooze"));
  });
  ...
  test('testR35_t042ast', () {
    ...
    CommonTokenStream tstream = new CommonTokenStream(lexer);
    t042astParser parser = new t042astParser(tstream);
    expect(() => parser.r35(), throwsA(new isInstanceOf<Exception>()));
  });
  ...
  test('test36a_t042ast', () {
    ...
    var ret = parser.r36();
    expect((ret.tree as Tree).toStringTree(), equals("(if (EXPR (+ 1 2)) fooze)"));
  });
  ...
  test('test36b_t042ast', () {
    ...
    var ret = parser.r36();
    expect((ret.tree as Tree).toStringTree(), equals("(if (EXPR (+ 1 2)) fooze fooze2)"));
  });
  ...
  test('test37_t042ast', () {
    ...
    var ret = parser.r37();
    expect((ret.tree as Tree).toStringTree(), equals("(+ (+ 1 2) 3)"));
  });
  ...
  test('test39a_t042ast', () {
    ...
    var ret = parser.r39();
    expect((ret.tree as Tree).toStringTree(), equals("(INDEX gnurz 1)"));
  });
  ...
  test('test39b_t042ast', () {
    ...
    var ret = parser.r39();
    expect((ret.tree as Tree).toStringTree(), equals("(CALL gnurz 2)"));
  });
  ...
  test('test39c_t042ast', () {
    ...
    var ret = parser.r39();
    expect((ret.tree as Tree).toStringTree(), equals("(FIELDACCESS gnurz gnurz)"));
  });
  ...
  test('test41_t042ast', () {
    ...
    var ret = parser.r41();
    expect((ret.tree as Tree).toStringTree(), equals("(3 (2 1))"));
  });
  ...
  test('test42_t042ast', () {
    ...
    var ret = parser.r42();
    expect((ret.tree as Tree).toStringTree(), equals("gnurz gnarz gnorz"));
  });
  ...
  test('test44_t042ast', () {
    ...
    var ret = parser.r44();
    expect((ret.tree as Tree).toStringTree(), equals("(gnorz (gnarz gnurz))"));
  });
  ...
  test('test49_t042ast', () {
    ...
    var ret = parser.r49();
    expect((ret.tree as Tree).toStringTree(), equals("(gnurz gnorz)"));
  });
  ...
  test('test50_t042ast', () {
    ...
    var ret = parser.r50();
    expect((ret.tree as Tree).toStringTree(), equals("(1.0 gnurz)"));
  });
  ...
  test('test51_t042ast', () {
    ...
    var ret = parser.r51();
    expect((ret.tree as Tree).toStringTree(), equals("gnurza gnurzb gnurzc"));
  });
  ...
  test('test54_t042ast', () {
    ...
    var ret = parser.r54();
    expect((ret.tree as Tree).toStringTree(), equals("(+ 1 2)"));
  });
  ...
  test('test55a_t042ast', () {
    ...
    var ret = parser.r55();
    expect((ret.tree as Tree).toStringTree(), equals("public private (+ 1 2)"));
  });
  ...
  test('test55b_t042ast', () {
    ...
    var ret = parser.r55();
    expect((ret.tree as Tree).toStringTree(), equals("public fooze"));
  });
  ...
  test('test59_t042ast', () {
    ...
    var ret = parser.r59();
    expect((ret.tree as Tree).toStringTree(), equals("(a fooze) (b fooze) (c fooze)"));
  });
}
